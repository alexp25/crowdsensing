...
polls_may = poll_df[(poll_df['date'] >= '2025-04-15') & (poll_df['date'] <= '2025-05-31')]
...
plt.plot(price_may['date'], price_may['Nicușor Dan'], label='Dan', color='blue', linewidth=2)
plt.plot(price_may['date'], price_may['George Simion'], label='Simion', color='orange', linewidth=2)
# plt.stem(polls_may['date'], polls_may['Dan']/100, label='Dan', markerfmt='blue')
# plt.stem(polls_may['date'], polls_may['Simion']/100, label='Simion', markerfmt='orange')

# plt.plot(polls_may['date'], polls_may['Dan']/100, label='Dan', color='blue', linewidth=4)
# plt.plot(polls_may['date'], polls_may['Simion']/100, label='Simion', color='orange', linewidth=4)

# plt.scatter(polls_may['date'], polls_may['Dan']/100, label='Dan', color='blue', linewidth=4)
# plt.scatter(polls_may['date'], polls_may['Simion']/100, label='Simion', color='orange', linewidth=4)
...
for idx, row in events_df.iterrows():
    ...
    plt.text(row['date'], 0.8, str(row["event_number"]), rotation=90, fontsize=12, color=color, verticalalignment='center')
